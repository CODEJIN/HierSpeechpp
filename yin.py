...
2023.12.21 - Heejo You fix for frame matching
"""
...
def estimate(
    ...
    signal = torch.nn.functional.pad(
        signal[:, None],
        ((window_size - hop_size) // 2, (window_size - hop_size) // 2),
        mode='reflect'
        )[:, 0]
    ...
    frames = _frame(signal, window_size, hop_size)
...
#     pitch_min= f0_min,
#     pitch_max= f0_max,
#     hop_size= f0_hop_size,
#     window_size= f0_hop_size * 4,
#     threshold= 0.1
#     )